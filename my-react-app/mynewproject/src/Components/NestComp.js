...
// function MyButton(){     // function definition
//     return (
//         <button >
//             Subscribe
//         </button>
...
// export default function myApp(){    // function declaration 
//     return (
//         <div>
...
//! function without default keyword 

export function NestComp(){
    return (
        <h1>This is Profile function without using default keyword</h1>
    )
}
