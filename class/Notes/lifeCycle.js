...
This is the phase when the component is being created and inserted into the DOM. It's crucial for initializing the component, setting up initial state, fetching data, and performing subscriptions.

1. ? constructor(props):
   - Purpose: Initializes the component, sets up the initial state, and binds event handler methods.
...
This phase deals with changes to props or state and re-rendering the component. It’s where you optimize performance and react to state transitions.
